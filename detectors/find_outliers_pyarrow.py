...
def main():
    ...
    try:
        # Read parquet schema first to resolve column names
    ...
    print(f"✓ Outlier detection complete ({filter_time:.2f}s)")
...
# Sort outliers by distance descending (most extreme first)
    ...
    # Performance summary
    total_time = load_time + filter_time + export_time
    print("\n" + "="*60)
    print("PERFORMANCE SUMMARY")
    print("="*60)
    print(f"  Data loading:        {load_time:>7.2f}s")
    print(f"  Outlier detection:   {filter_time:>7.2f}s")
